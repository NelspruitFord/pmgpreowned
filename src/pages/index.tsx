                                       ...
                                       <table className="w-full">
                                          <tbody className="w-full">
                                             <tr className="w-full">
                                                ...
                                                <td className="absolute right-10 translate-y-5">
